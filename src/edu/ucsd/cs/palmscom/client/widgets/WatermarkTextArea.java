 ...
 *
 */
public class WatermarkTextArea extends TextArea implements BlurHandler, FocusHandler
{
	private String watermark;
	private HandlerRegistration blurHandler;
	private HandlerRegistration focusHandler;
	
	public WatermarkTextArea( )
	{
		super();
		this.setStylePrimaryName("textInput");
	}
	
	public WatermarkTextArea(String defaultValue)
	{
		this();
		setText(defaultValue);
	}
	
	public WatermarkTextArea(String defaultValue, String watermark)
	{
		this(defaultValue);
